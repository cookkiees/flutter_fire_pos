...
class AccountingBarChartWidget extends StatelessWidget {
  const AccountingBarChartWidget({super.key, required this.reportProvider});
  ...
  Widget build(BuildContext context) {
    ...
    double maxProfit = reportProvider.monthlyProfits.isNotEmpty
        ? reportProvider.monthlyProfits.reduce(max)
        : 0;
    ...
    final barGroups = List<BarChartGroupData>.generate(
      ...
      (index) => BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            toY: reportProvider.monthlyProfits.isNotEmpty
                ? reportProvider.monthlyProfits[index].toDouble()
                : 0,
            width: 16,
